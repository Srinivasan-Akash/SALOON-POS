...
import { appointmentsCollection, appointmentsDocument, databaseID, databases } from "../../../../appwrite/config";
export default function Calender() {
    ...
    useEffect(() => {
        databases.getDocument(databaseID, appointmentsCollection, appointmentsDocument)
            .then(response => {
    ...
    useEffect(() => {
        if (scheduleData.length > 0) {
            databases.updateDocument(databaseID, appointmentsCollection, appointmentsDocument, {
